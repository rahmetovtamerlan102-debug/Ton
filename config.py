...
# Базовый URL, где захостен ton_ledger_report.html (production HTML-отчёт).
# Если задан — кнопка "Полный отчёт" открывает эту страницу как Telegram Mini App
# с адресом кошелька, подставленным в ?addr=..., без повторного ввода.
